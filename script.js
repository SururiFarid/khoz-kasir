...
function selesaiDanCetak(){
    ...
    <body>
       ...
       <div class="info">
            ...
            <div>JAM : ${waktu.toLocaleTimeString("id-ID")}</div>
        </div>
...
function lihatDetail(index){
    ...
    const tanggal = new Date(trx.timestamp);
    ...
    <body>
        ...
        <div class="info">
            <div>NO TRANSAKSI : ${trx.noTransaksi}</div>
            <div>KASIR : ${trx.kasir}</div>
            <div>TANGGAL : ${tanggal.toLocaleDateString("id-ID",{
                day:"2-digit",
                month:"long",
                year:"numeric"
            })}</div>
            <div>JAM : ${tanggal.toLocaleTimeString("id-ID")}</div>
        </div>
        ...
        <div class="total">
            <p>Total : Rp ${formatRupiah(trx.total)}</p>
            <p>Bayar : Rp ${formatRupiah(trx.bayar)}</p>
            <p>Kembali : Rp ${formatRupiah(trx.kembali)}</p>
        </div>
...
function printUlang(index){
    ...
    const waktu = new Date(trx.timestamp);
